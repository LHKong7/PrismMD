...
export const themes: ThemeDefinition[] = [
  ...
  },
  {
    ...
    colors: {
      ...
      '--accent-hover': '#723a10',
      '--code-bg': '#e8dfd2',
      '--highlight-yellow': '#f0e0b8',
      '--highlight-green': '#d0dfc0',
      '--highlight-blue': '#c8d8e8',
      '--highlight-pink': '#ecd0d8',
      '--highlight-purple': '#dcd0e0',
  ...
  },
  {
    ...
    colors: {
      ...
      '--accent-hover': '#e0a848',
      '--code-bg': '#2a2218',
      '--highlight-yellow': '#3d3018',
      '--highlight-green': '#1a2a18',
      '--highlight-blue': '#182028',
      '--highlight-pink': '#2a1818',
      '--highlight-purple': '#221828',
      '--scrollbar-thumb': '#5a4a38',
      '--progress-bar': '#d4943a',
      '--color-error': '#e85c5c',
      '--color-error-bg': 'rgba(232, 92, 92, 0.12)',
      '--color-error-border': 'rgba(232, 92, 92, 0.45)',
      '--color-warning': '#e8a040',
      '--color-warning-bg': 'rgba(232, 160, 64, 0.12)',
      '--color-warning-border': 'rgba(232, 160, 64, 0.45)',
      '--color-success': '#5cb870',
      '--color-success-bg': 'rgba(92, 184, 112, 0.12)',
      '--color-success-border': 'rgba(92, 184, 112, 0.4)',
      '--color-info': '#68b0d8',
      '--color-info-bg': 'rgba(104, 176, 216, 0.12)',
